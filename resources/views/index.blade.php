        ...
        <!-- banner-part-start  -->
                ...
                <section class="banner-two" style="background-color: black;">
                    <div class="container py-3 py-md-5">
                        <div class="row align-items-center justify-content-center" style="min-height: 25vh;">
                            <div class="col-12 text-center">
                                <h1 class="display-2 fw-bold text-white text-center-mobile mb-2" style="font-family: 'Cairo', sans-serif;">
                                    {{ $homepage->home1_intro_title }}
                                </h1>
                                <span class="text-white text-center-mobile d-block" style="font-family:'Cairo', sans-serif; font-size: 30px;">
