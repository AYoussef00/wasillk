                                ...
                                <div class="car-images">
                                    ...
                                    <div class="car-images-inner">
                                        ...
                                        <div class="description-item two">
                                            ...
                                            <div class="description-item-inner">
                                                <label for="custom_id" class="form-label">{{ __('translate.Custom ID') }}
                                                    <span>*</span> </label>
                                                <input type="text" class="form-control" id="custom_id"
                                                    placeholder="{{ __('translate.Custom ID') }}" name="custom_id" value="{{ old('custom_id') }}">
                                            </div>
                                        
                                            <div class="description-item-inner">
                                                <label for="plate_number" class="form-label">{{ __('translate.Plate Number') }}
                                                    <span>*</span> </label>
                                                <input type="text" class="form-control" id="plate_number"
                                                    placeholder="{{ __('translate.Plate Number') }}" name="plate_number" value="{{ old('plate_number') }}">
                                            </div>
