...
@section('body-content')
    <main>
                                        ...
                                        <form class="banner-sarchber-box-item" action="{{ route('listings') }}">
                                            ...
                                            <span class="icon">
                                                ...
                                                <select class="form-select form-select-lg"
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option
                                                            {{ request()->get('country') == $country->id ? 'selected' : '' }} value="{{ $country->id }}">{{ $country->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                <select class="form-select form-select-lg"
                                                    ...
                                                    <option
                                                        value="price_low_high">{{ Session::get('currency_icon') }}{{ __('translate.(Low-High)') }}</option>
                                                    <option
                                                        value="price_high_low">{{ Session::get('currency_icon') }}{{ __('translate.(High-Low)') }}</option>
                                                </select>
                                            </div>
                        ...
                        <ul class="nav nav-pills " id="pills-tab1" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true">{{ __('translate.Buy New Car') }}</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-profile" type="button" role="tab"
                                        aria-controls="pills-profile"
                                        aria-selected="false">{{ __('translate.Rent Car') }}</button>
                            </li>
                        </ul>
                    </div>
                </div>
                                            ...
                                            <div class="brand-car-item">
                                                <div class="brand-car-item-img">
                                                    ...
                                                    <div class="brand-car-item-img-text">
                                                        ...
                                                        <div class="text-df">
                                                            @if ($car->offer_price)
                                                                <p class="text">{{ calculate_percentage($car->regular_price, $car->offer_price) }}
                                                                    % {{ __('translate.Off') }}</p>
                                                            @endif
                                                        ...
                                                        <div class="icon-main">
                                                            ...
                                                            @guest('web')
                                                                <a href="javascript:;"
                                                                   class="icon before_auth_wishlist">
                                                                <span>
                                                            ...
                                                            <span>
                                                                <svg width="18" height="20" viewBox="0 0 18 20"
                                                                    ...
                                                                    <path
                                                                        d="M17 10V11C17 13.7614 14.7614 16 12 16H1L4 19"
                                                                        stroke-width="1.3" stroke-linecap="round"
                                                                        stroke-linejoin="round"/>
                                                                </svg>
                                                            </span>
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                ...
                                <div class="row g-5">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                        <div class="brand-car-item d-flex flex-column h-100 p-0 border-0">
                                           {{-- الصورة --}}
        <div class="brand-car-item-img position-relative">
            <img src="{{ getImageOrPlaceholder($car->thumb_image, '330x230') }}"
                 alt="thumb"
                 class="img-fluid w-100 h-100 object-fit-cover" style="min-height: 230px;">

            {{-- محتوى فوق الصورة زي الخصم والحالة --}}
            <div class="brand-car-item-img-text position-absolute top-0 start-0 w-100">
                <div class="text-df d-flex justify-content-between p-2">
                    @if ($car->offer_price)
                        <p class="text bg-danger text-white p-1 m-0">
                            {{ calculate_percentage($car->regular_price, $car->offer_price) }}% {{ __('translate.Off') }}
                        </p>
                    @endif
                    <p class="text text-two bg-primary text-white p-1 m-0">
                        ...
                        <div class="brand-car-btn mt-48px">
                            <a href="{{ route('listings') }}"
                               class="thm-btn-two">{{ __('translate.View More Car List') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class=" col-xl-6 col-lg-8">
                            <div class="feature-two-img-main">
                                <div class="feature-two-img">
                                    <a href="{{ $home1_ads->link }}"><img src="{{ getImageOrPlaceholder($home1_ads->image, '690x460') }}" alt="thumb"></a>
                                </div>
                            </div>
                        </div>
                    @endif
        ...
        <!--  Loan-part-start -->
        {{-- <section class="loan"
                 style="background-image: url({{ asset($homepage->loan_bg_image) }});">
            <div class="container">
                <div class="row ">
                        ...
                        <div class="row ">
                            <div class="col-lg-7 col-sm-6">
                                <h2 class="loan-taitel">{{ __('translate.Auto Loan') }}
                                    <span>{{ __('translate.Calculator') }}</span></h2>
                                <form>
                                    ...
                                    <div class="loan-form-min">
                                        ...
                                        <div class="loan-form-item">
                                            ...
                                            <div class="icon">
                                            <span>
                                                <svg class="svg-two" width="24" height="16" viewBox="0 0 16 16"
                                                     fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                            ...
                            <div class="col-lg-5 col-sm-6">
                                <div class="estimate-item">
                                    ...
                                    <div class="estimate-img">
                                        <img src="{{ asset($homepage->loan_foreground_image) }}" alt="img">
                                    </div>

                                    <div class="estimate-payment">
                                        <ul>
                                            <li>{{ __('translate.Monthly Payment') }}: <span
                                                    id="monthly_payment">{{ currency(0.00) }}</span></li>
                                            <li>{{ __('translate.Total Interest') }}:<span
                                                    id="total_interest">{{ currency(0.00) }}</span></li>
                                            <li>{{ __('translate.Total Payment') }}: <span
                                                    id="total_payment">{{ currency(0.00) }}</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
@push('js_section')
    ...
    <script>
        ...
        function calculateTotalInterest(loanAmount, interestRate, loanTermYears) {
            let totalPayments = loanTermYears * 12;
            let totalInterest = (calculateMonthlyPayment(loanAmount, interestRate, loanTermYears) * totalPayments) - loanAmount;
