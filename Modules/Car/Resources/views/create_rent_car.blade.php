                                ...
                                <div class="col-12 mg-top-30">
                                    ...
                                    <div class="crancy-product-card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="crancy__item-form--group mg-top-form-20">
                                                    <label class="crancy__item-label">{{ __('translate.Custom ID') }} *</label>
                                                    <input class="crancy__item-input" type="text" name="custom_id" id="custom_id" value="{{ old('custom_id') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="crancy__item-form--group mg-top-form-20">
                                                    <label class="crancy__item-label">{{ __('translate.Plate Number') }} *</label>
                                                    <input class="crancy__item-input" type="text" name="plate_number" id="plate_number" value="{{ old('plate_number') }}">
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="crancy__item-form--group w-100 h-100">
                                                            ...
                                                            <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                ...
                                                                <label class="crancy-image-video-upload__label" for="video_image">
                                                                    <img id="view_video_img" src="{{ asset($setting->placeholder_image) }}">
                                                                    <h4 class="crancy-image-video-upload__title">{{ __('translate.Click here to') }} <span class="crancy-primary-color">{{ __('translate.Choose File') }}</span> {{ __('translate.and upload') }} </h4>
                                                                </label>
                                                            </div>
                                                        </div>
