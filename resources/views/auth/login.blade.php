            ...
            <div class="row login-bg">
                <div class="col-lg-6">
                        ...
                        <div class="login-form-item two">
                            <div class="login-form-inner">
                                <label class="form-label">{{ __('translate.Password') }}
                                    ...
                                    placeholder="......" name="password" id="input_password" value="1234">
                                    @else
                                    <input type="password" class="form-control"
                    ...
                    <div class="create-accoun-text">
                        <p>{{ __('translate.Do not have an account ?') }}<span><a href="{{ route('register') }}"> {{ __('translate.Sign Up Here') }}</a></span></p>
                    </div>
